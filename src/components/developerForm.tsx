...
import { fieldName, useCandidate } from "../context/candidate";
...
const DeveloperForm = () => {
    ...
    const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const request = new Request("http://localhost:3000/candidates/", {
            method: "POST",
    ...
    return (
        ...
        >
            <div className="grid grid-cols-2 gap-11">
                ...
                {/* Earliest Possible Start Date, Latest Possible End Date */}
                <Input
                    name="date"
